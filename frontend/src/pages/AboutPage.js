    ...
    return (
        ...
        <nav className="about-nav">
            ...
            <li className={onNavigate ? 'clickable' : ''} onClick={() => onNavigate && onNavigate('services')}>Services</li>
        ...
        <section className="about-content">
            ...
            <div className="description-text">
                <h2>Our Mission</h2>
                <p>
                The Audio Visual Resource Center is dedicated to providing top-quality equipment and support 
                for creative projects, educational initiatives, and professional productions. We believe in making 
                advanced audio and visual technology accessible to everyone.
                </p>
                <p>
                With our comprehensive inventory and knowledgeable team, we ensure every reservation experience 
                is smooth and successful. Whether you're a student, educator, or professional, we're here to help 
                bring your ideas to life through sound and vision.
                </p>
            </div>
            </div>

            <div className="features-grid">
            <h2 style={{gridColumn: '1 / -1', textAlign: 'center', fontSize: '2rem', marginBottom: '30px'}}>
                Why Choose Us?
            </h2>
